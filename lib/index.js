...
const
    ...
    CNCT_user_verification	= 6; // Attach/create using this connection
...
Connection.prototype.connect = function (database, callback) {
    ...
    blr.addString(CNCT_user, process.env['USER'] || process.env['USERNAME'] || 'Unknown', DEFAULT_ENCODING);
    var hostname = os.hostname();
    blr.addString(CNCT_host, hostname, DEFAULT_ENCODING);
